...
class RNN(nn.Module):
    ...
    def forward(self, inputs, directions, mask, goal, epoch=None, type=None, y=None):
        ...
        # print(f'pred_goald_logits: {pred_goald_logits.shape}')
        ...
        # print(f'last_obs: {link_embs.shape}')
        ...
        # print(f'after projection, link_embs: {link_embs.shape}')
        ...
        # print(f'direction_tail_embs: {direction_tail_embs.shape}')
